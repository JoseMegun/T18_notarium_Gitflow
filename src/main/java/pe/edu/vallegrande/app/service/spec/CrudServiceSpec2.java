...
public interface CrudServiceSpec2<T> {
	...
	/**
	 * Activa o elimina logicamente un registro de la base de datos.
	 * @param id El id del registro a activar/eliminar.
	 */
